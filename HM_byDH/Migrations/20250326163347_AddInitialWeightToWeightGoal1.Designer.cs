...
namespace HM_byDH.Migrations
{
    ...
    [Migration("20250326163347_AddInitialWeightToWeightGoal1")]
    partial class AddInitialWeightToWeightGoal1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HM_byDH.Models.ActivityEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HM_byDH.Models.ActivityGoal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HM_byDH.Models.ActivityType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HM_byDH.Models.Advice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HM_byDH.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HM_byDH.Models.FoodEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HM_byDH.Models.FoodItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HM_byDH.Models.ActivityEntry", b =>
                {
                    b.HasOne("HM_byDH.Models.ActivityType", "ActivityType")
                        .WithMany()
            ...
            modelBuilder.Entity("HM_byDH.Models.FoodEntry", b =>
                {
                    b.HasOne("HM_byDH.Models.FoodItem", "FoodItem")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HM_byDH.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
